...
|---|---|---|---|---|---|---|
| 0 Setup | `phase-0-setup` | owned ESP32-S3 | ESP-IDF + Arduino-ESP32 | (README Phase 0) | — | first, blocks all |
| 1 BLE | `phase-1-ble` | owned ESP32-S3 | ESP-IDF | [component-ble-crowdsourced.md](component-ble-crowdsourced.md) | 0 | ∥ with Phase 2 |
| 2 Cellular/GPS | `phase-2-cellular` | T-SIM7670G-S3 | Arduino + TinyGSM fork | [component-cellular-gps.md](component-cellular-gps.md) | 0 (+ board purchase) | ∥ with Phase 1 |
| 3 Power | `phase-3-power` | T-SIM7670G-S3 | hardware | [component-power.md](component-power.md) | 2 | after 2 |
| 4 Traccar | `phase-4-traccar` | T-SIM7670G-S3 | Arduino + data uplink | [component-reporting.md](component-reporting.md) | 2 | optional |
| 5 Merge | `phase-5-merge` | T-SIM7670G-S3 | both | (README Phase 5) | 1 + 2 | optional, last |

## Sequencing notes
- **Phase 0 first, and it blocks everything.** "Done" = flash and serial-monitor a
  hello-world on the owned ESP32-S3.
- **Phase 1 and Phase 2 are independent** — different boards and different toolchains —
  so two sessions can run them on separate branches at the same time.
...
- **Much of Phase 1/2 is integration, not greenfield code:** Macless-Haystack and
  GoogleFindMyTools (Phase 1), the LilyGO TinyGSM fork (Phase 2), plus hardware flashing.
  Expect research, porting, and verification work as much as new firmware.
